...
async function setupGPUDeviceStaticRender(canvas) {
...
async function renderGPUStatic(scene) {
    ...
    encoder.copyTextureToTexture({texture: texture}, {texture: storageTexture}, {width: camera.imgW, height: camera.imgH});
